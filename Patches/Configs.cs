...
internal class Configs
{
   ...
   // public static ConfigEntry<KeyboardShortcut> toggleKey;
    ...
    internal static void Generate()
    {
        ...
        //Items//
        fe_fire_pit = NoSmokeStayLit.context.config("Fire Things Keep Lit", "Camp Fire Keep Lit", true, "Allow eternal fuel for Campfire");
        fe_bonfire = NoSmokeStayLit.context.config("Fire Things Keep Lit", "Bonfire Keep Lit", true, "Allow eternal fuel for Bonfire");
        fe_hearth = NoSmokeStayLit.context.config("Fire Things Keep Lit", "Hearth Keep Lit", true, "Allow eternal fuel for Hearth");
        fe_piece_walltorch = NoSmokeStayLit.context.config("Fire Things Keep Lit", "Wall Torch Keep Lit", true, "Allow eternal fuel for Sconce");
        fe_piece_groundtorch = NoSmokeStayLit.context.config("Fire Things Keep Lit", "Iron Torch Keep Lit", true, "Allow eternal fuel for Standing iron torch");
        fe_piece_groundtorch_wood = NoSmokeStayLit.context.config("Fire Things Keep Lit", "Wood Torch Keep Lit", true, "Allow eternal fuel for Standing wood torch");
        fe_piece_groundtorch_green = NoSmokeStayLit.context.config("Fire Things Keep Lit", "Green Torch Keep Lit", true, "Allow eternal fuel for Standing green-burning iron torch");
        fe_piece_groundtorch_blue = NoSmokeStayLit.context.config("Fire Things Keep Lit", "Blue Torch Keep Lit", true, "Allow eternal fuel for Standing blue-burning iron torch");
        fe_piece_brazierfloor01 = NoSmokeStayLit.context.config("Fire Things Keep Lit", "Standing Brazier Keep Lit", true, "Allow eternal fuel for Standing brazier");
        fe_piece_brazierceiling01 = NoSmokeStayLit.context.config("Fire Things Keep Lit", "Ceiling Brazier Keep Lit", true, "Allow eternal fuel for Hanging brazier");
        fe_piece_jackoturnip = NoSmokeStayLit.context.config("Fire Things Keep Lit", "JackOTurnip Keep Lit", true, "Allow eternal fuel for Jack-o-turnip");
        fe_piece_oven = NoSmokeStayLit.context.config("Smelters Keep Lit", "Stone Oven Keep Fueled", true, "Allow eternal fuel for Stone oven");
        fe_piece_bathtub = NoSmokeStayLit.context.config("Smelters Keep Lit", "HotTub Keep Fueled", true, "Allow eternal fuel for Hot tub");
        fe_smelter = NoSmokeStayLit.context.config("Smelters Keep Lit", "Smelter Keep Fueled", false, "Allow eternal fuel for Smelter");
        fe_blastfurnace = NoSmokeStayLit.context.config("Smelters Keep Lit", "BlastFurnace Keep Fueled", false, "Allow eternal fuel for Blast furnace");
        fe_eitrrefinery = NoSmokeStayLit.context.config("Smelters Keep Lit", "EitrRefinery Keep Fueled", false, "Allow eternal fuel for Eitr refinery");
        ...
        fe_piece_walltorch_timer = NoSmokeStayLit.context.config("Timed Torches", "Wall Torch on Timer", true, "Allow timer fuel for Sconce");
        fe_piece_groundtorch_timer = NoSmokeStayLit.context.config("Timed Torches", "Iron Torch On Timer", true, "Allow timer for Standing iron torch");
        fe_piece_groundtorch_wood_timer = NoSmokeStayLit.context.config("Timed Torches", "Wood Torch on Timer", true, "Allow timer for Standing wood torch");
        fe_piece_groundtorch_green_timer = NoSmokeStayLit.context.config("Timed Torches", "Green Torch on Timer", true, "Allow timer for Standing green-burning iron torch");
        fe_piece_groundtorch_blue_timer = NoSmokeStayLit.context.config("Timed Torches", "Blue Torch on Timer", true, "Allow timer for Standing blue-burning iron torch");
        fe_piece_brazierfloor01_timer = NoSmokeStayLit.context.config("Timed Torches", "Standing Brazier on Timer", true, "Allow timer for Standing brazier");
        fe_piece_brazierceiling01_timer = NoSmokeStayLit.context.config("Timed Torches", "Ceiling Brazier on Timer", true, "Allow timer for Hanging brazier");
        fe_piece_jackoturnip_timer = NoSmokeStayLit.context.config("Timed Torches", "Jackoturnip on Timer", true, "Allow timer for Jack-o-turnip");
        fe_custom_instance_timer = NoSmokeStayLit.context.config("Custom", "Custom Items on Timers", "", "Enable Timers for items added by other mods, " +
            "comma-separated no spaces (e.g. \"rk_campfire,rk_hearth,rk_brazier\" )");
        keepOnInRain = NoSmokeStayLit.context.config<bool>("Basic Settings", "Keep on when wet", true, "Keep fires lit even when raining and wet");
        //Timer Settings//
        timerOnHours = NoSmokeStayLit.context.config("Timer Settings", "Timer On Hours (Night Time)", 17, 
        ...
        timerOnMinutes = NoSmokeStayLit.context.config("Timer Settings", "Timer On Mins (Night Time)", 0, 
        ...
        timerOffHours = NoSmokeStayLit.context.config("Timer Settings", "Timer Off Hours (Day Time)", 5, 
        ...
        timerOffMinutes = NoSmokeStayLit.context.config("Timer Settings", "Timer Off Mins (Day Time)", 30, 
            new ConfigDescription("Minutes in the hour.  This will be added to the hours above.", 
            new AcceptableValueRange<int>(0, 60), null, new ConfigurationManagerAttributes { Order = 9 }));
        fe_fire_pit_smoke = NoSmokeStayLit.context.config("Really, I Want Smoke", "Camp Fire Enable Smoke", false, "Enable eternal Smoke for Bonfire");
        fe_hearth_smoke = NoSmokeStayLit.context.config("Really, I Want Smoke", "Hearth Enable Smoke", false, "Enable Smoke for Hearth");
        fe_piece_brazierfloor01_smoke = NoSmokeStayLit.context.config("Really, I Want Smoke", "Standing Brazier Enable Smoke", false, "Enable for Standing brazier");
        fe_piece_brazierceiling01_smoke = NoSmokeStayLit.context.config("Really, I Want Smoke", "Ceiling Brazier Enable Smoke", false, "Enable timer for Hanging brazier");
        fe_smelter_smoke = NoSmokeStayLit.context.config("Really, I Want Smoke", "Smelter Enable Smoke", false, "Enable Smoke for Smelter.  This disables Smelter Stacking");
        ...
        configAlwaysOnInDarkBiomes = NoSmokeStayLit.context.config("Basic Settings", "Always On In Dark Biomes", true, 
